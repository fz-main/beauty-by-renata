        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <div className="space-y-6 font-montreal text-sm md:text-base text-white/70 leading-relaxed">
            ...
            <section>
              ...
              <p>Reklamaci je nutné uplatnit bez zbytečného odkladu po zjištění vady, nejpozději však do 5 dnů od poskytnutí služby. Reklamaci lze uplatnit telefonicky, e-mailem nebo osobně v salonu.</p>
            </section>
            ...
            <section>
              ...
              <p>Zákazník může termín bezplatně zrušit nebo přeobjednat nejpozději 24 hodin před plánovaným termínem. Při pozdějším zrušení nebo nedostavení se na termín bez omluvy si salon vyhrazuje právo na účtování storno poplatku ve výši 50 % ceny služby.</p>
            </section>
            ...
            <section>
              ...
              <div className="mt-2 space-y-1">
                <p>Renata Birjukov</p>
                <p><a href="tel:+420734501706" className="text-[#e5d3b3] hover:underline">+420 734 501 706</a></p>
                <p><a href="mailto:birjukov.renata@gmail.com" className="text-[#e5d3b3] hover:underline">birjukov.renata@gmail.com</a></p>
                <p>Vránova 1245/5, Brno – Řečkovice, 621 00</p>
              </div>
            </section>
          </div>
        </motion.div>
