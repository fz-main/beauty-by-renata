...
export default function MenuButton({ service, translatedTitle, translatedSubtitle, onClick, enterLabel = '[ ENTER ]' }: MenuButtonProps) {
  return (
    <motion.button
      ...
      whileHover="hover"
      style={{ flex: '1 1 auto', minWidth: '100px', maxWidth: '200px' }}
    >
      <motion.div
      ...
      <motion.div
        ...
        className="font-montreal text-[8px] md:text-[9px] text-white/50 text-center mt-0.5 max-w-[160px] leading-tight"
      >
