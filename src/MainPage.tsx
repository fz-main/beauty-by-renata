    ...
    <div className="w-screen h-screen bg-[#0a0a0a] text-[#f8f5f2] overflow-hidden relative selection:bg-[#e5d3b3] selection:text-black">
      ...
      {showHeroVideo && (
        <div className="fixed inset-0 z-[200] bg-black">
          <video autoPlay muted playsInline onEnded={() => { setHeroFading(false); setShowHeroVideo(false); setStage(STAGES.MENU); }} className="w-full h-full object-cover">
