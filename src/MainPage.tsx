  ...
  useEffect(() => {
    ...
    const handleWheel = (e: WheelEvent) => {
      ...
      if (stage === STAGES.INTRO && e.deltaY > 0) {
        setHeroFading(true);
        setTimeout(() => { setShowHeroVideo(true); setHeroFading(false); }, 800);
